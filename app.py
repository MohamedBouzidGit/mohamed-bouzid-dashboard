...
def transform_raw_data(path):
    ...
    raw_data = pd.read_csv(path, sep=',', nrows=n_rows, index_col='SK_ID_CURR')
...
def load_app_train_clean():
    app_train_clean = pd.read_csv('https://media.githubusercontent.com/media/MohamedBouzidGit/mohamed-bouzid-dashboard/master/app_train_clean_30000.csv', sep=',', nrows=n_rows, index_col=0)
